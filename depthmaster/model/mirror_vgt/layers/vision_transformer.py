"""
Original source: HunyuanWorld-Mirror/src/models/layers/vision_transformer.py
Migrated into DepthMaster (mirror_vgt subpackage).

NOTE: The original version imported `RankedLogger` from `training.utils.logger`
      (PyTorch Lightning-based training stack). Since DepthMaster does not use Lightning,
      it has been replaced by a plain `logging.Logger`.
"""
# References:
...
# Use plain stdlib logging instead of Lightning's RankedLogger.
