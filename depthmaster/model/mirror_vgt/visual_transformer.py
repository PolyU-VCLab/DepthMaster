"""
Original source: HunyuanWorld-Mirror/src/models/models/visual_transformer.py
Migrated into DepthMaster (mirror_vgt subpackage).

Main backbone: VisualGeometryTransformer (VGT) from VGGT-style alternating attention.
"""
import logging
import random
