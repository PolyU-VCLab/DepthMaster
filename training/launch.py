...
# os.environ['PYTORCH_CUDA_ALLOC_CONF'] = os.environ['PYTORCH_CUDA_ALLOC_CONF'] = 'max_split_size_mb:1024'
import hydra
import lightning as L
from omegaconf import DictConfig, OmegaConf, ListConfig

import rootutils
rootutils.setup_root(__file__, indicator="requirements.txt", pythonpath=True)
